...
const ProfilePage = () => {
  ...
  return (
    <div className="sticky flex-none h-screen bg-accent sm:px-5 sm:py-5 shadow-sm lg:w-96">
      ...
      <div className="relative mx-auto flex w-full justify-center pt-14 -z-50">
        <label htmlFor="avatarUpload" className="cursor-pointer group">
          <div className="relative w-40 h-40">
            <img
              src={uploadedUrl || "/placeholder-avatar.png"}
              alt="Avatar"
              className="w-full h-full rounded-full object-cover border-4 z-10 border-gray-300"
            />
      ...
      <div className="w-full space-y-4 pt-12 px-12 sm:px-0 pb-5">
        <Input
          value={username}
